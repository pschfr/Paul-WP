...
<footer id="footer" role="contentinfo">
	<div class='grid container'>
		<div class='grid__col--1-of-4 grid__col'>
			<p>Bacon ipsum dolor amet tenderloin meatball chicken kielbasa, ball tip salami capicola fatback venison chuck. Spare ribs turducken t-bone corned beef rump pork loin picanha capicola, brisket pork chop pork.</p>
		</div>
		<div class='grid__col--1-of-4 grid__col'>
			<p>Sirloin strip steak ground round flank ham hock boudin shank pig pork belly shankle. Ground round meatball swine ribeye, fatback corned beef spare ribs biltong capicola boudin.</p>
		</div>
		<div class='grid__col--1-of-4 grid__col'>
